...
Twilito is designed for currently maintained Ruby versions. (3.2 and up as of 12/2025). Unit tests [run in CI](https://github.com/alexford/twilito/actions) on 3.2, 3.3, 3.4, and 4.0
